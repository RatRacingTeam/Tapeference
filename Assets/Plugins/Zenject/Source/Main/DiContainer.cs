...
namespace Zenject
{
    ...
    public class DiContainer : IInstantiator
    {
            ...
            InjectContext context, object concreteIdentifier)
        {
            ...
            // GlobalInstallers are the only things that we instantiate/inject on during validation
